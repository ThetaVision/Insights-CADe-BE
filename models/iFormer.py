...
Current implementation adapted from: https://github.com/sail-sg/iFormer/blob/main/models/inception_transformer.py
"""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.proj1 = nn.Conv2d(
            cnn_dim, cnn_dim, kernel_size=kernel_size, stride=stride, padding=padding, bias=False, groups=cnn_dim
        )
...
class LowMixer(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.pool = (
            nn.AvgPool2d(pool_size, stride=pool_size, padding=0, count_include_pad=False)
            if pool_size > 1
            else nn.Identity()
        )
...
urls = {
    'iformer_small': 'https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_small.pth',
    'iformer_base': 'https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_base.pth',
    'iformer_large': 'https://huggingface.co/sail/dl2/resolve/main/iformer/iformer_large.pth',
}
...
class InceptionTransformer(nn.Module):
    ...
    def init_weights(self, mode=''):
        ...
        trunc_normal_(self.pos_embed4, std=0.02)
...
@register_model
def iformer_small(opt, pretrained=False, **kwargs):
    """
    ...
    url = urls['iformer_small']
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(url=url, map_location="cpu", check_hash=True)
        del state_dict['pos_embed1']
        del state_dict['pos_embed2']
        del state_dict['pos_embed3']
        del state_dict['pos_embed4']
...
@register_model
def iformer_base(opt, pretrained=False, **kwargs):
    """
...
@register_model
def iformer_large(opt, pretrained=False, **kwargs):
    """
