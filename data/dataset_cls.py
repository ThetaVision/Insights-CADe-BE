...
from data.domain_augmentations_cls import MotionBlur, ZoomBlur, LensBlur, MedianBlur, DefocusBlur
from data.domain_augmentations_cls import IncreasedContrast, DecreasedContrast
from data.domain_augmentations_cls import IncreasedBrightness, DecreasedBrightness
from data.domain_augmentations_cls import IncreasedSaturation, DecreasedSaturation
from data.domain_augmentations_cls import HueRed, HueGreen
from data.domain_augmentations_cls import IncreasedSharpness, DecreasedSharpness
...
NBI_MEAN = (0.47313396, 0.41963712, 0.36660876)  # NBI RGB VALUES
NBI_STD = (0.17489209, 0.17826953, 0.16448126)  # NBI RGB VALUES
